...
{
    // Item 0
    QuoteMoveLogicNone = 1,
    // Item 2
    QuoteMoveLogicMoveHitSide = 2,
    // Item 3
    QuoteMoveLogicMoveBothSides = 3
};
...
// Strategy parameter "Move on fills", type "Integer"
...
// Strategy parameter "Max number of trades", type "Integer"
...
// Strategy parameter "Spread", type "Double"
...
// Strategy parameter "Move ticks", type "Integer"
...
// Strategy parameter "Max moves", type "Integer"
...
// Strategy parameter "Quote move logic", type "Integer"
...
// Role "ReadOnly", description "Read Only Accounts"
tbricks::Uuid ReadOnlyIdentifier();
